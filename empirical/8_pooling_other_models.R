...
mypool = function(ll1,ll2){
  # resDN = PMCMC_delNegro(ll1,ll2,1000,c(0,2),10000,propsd = 0.5)
  ...
  res=list(ws_gew,lL_gew,ws_jore1,lL_jore1,lL_equal)
  names(res) = c('ws_gew','lL_gew','ws_jore1','lL_jore1','lL_equal')
  return(res)
}
...
# 1. DCC-t + DCC
res1 = mypool(ll1=lL_tdcc,ll2=lL_dcc)
# 2. DCC-t + Static
res2 = mypool(ll1=lL_tdcc,ll2= mat)
# 3. CAW+AIW
res3 = mypool(ll1=lL_caw,ll2=lL_xm)
# 4. CAW+Static
res4 = mypool(ll1=lL_caw,ll2=mat.st)
...
lines(tail(date,K),cumsum(apply(res1$lL_gew,2,median))-cumsum(apply(best.model$lL_gew,2,median)),
      col=1,lwd=2)
lines(tail(date,K),cumsum(apply(res1$lL_jore1,2,median))-cumsum(apply(best.model$lL_jore1,2,median)),
      col='pink',lwd=2)
lines(tail(date,K),cumsum(apply(res1$lL_equal,2,median))-cumsum(apply(best.model$lL_equal,2,median)),
...
plot(tail(date,K),rep(0,K),type='l',ylim=c(-750,10),ylab='',xlab='',xaxt="n",
     xlim=c(date[(nn+1)]-move.axis,date[(nn+K)]))
lines(tail(date,K),cumsum(apply(res2$lL_gew,2,median))-cumsum(apply(best.model$lL_gew,2,median)),
      col=1,lwd=2)
lines(tail(date,K),cumsum(apply(res2$lL_jore1,2,median))-cumsum(apply(best.model$lL_jore1,2,median)),
      col='pink',lwd=2)
lines(tail(date,K),cumsum(apply(res2$lL_equal,2,median))-cumsum(apply(best.model$lL_equa,2,median)),
      col='coral',lwd=2,lty=2)
axis(1, at=atx, labels=format(atx, "%Y/%m"),las=2,cex.axis=0.75)
...
par(new = TRUE)
plot(tail(date,K),rep(0,K),type='l',ylim=c(-400,10),ylab='',xlab='',xaxt="n",
     xlim=c(date[(nn+1)]-move.axis,date[(nn+K)]))
lines(tail(date,K),cumsum(apply(res3$lL_gew,2,median))-cumsum(apply(best.model$lL_gew,2,median)),
      col=1,lwd=2)
lines(tail(date,K),cumsum(apply(res3$lL_jore1,2,median))-cumsum(apply(best.model$lL_jore1,2,median)),
      col='pink',lwd=2)
lines(tail(date,K),cumsum(apply(res3$lL_equal,2,median))-cumsum(apply(best.model$lL_equal,2,median)),
      col='coral',lwd=2,lty=2)
axis(1, at=atx, labels=format(atx, "%Y/%m"),las=2,cex.axis=0.75)
legend(x=date[(nn+1)]-move.axis-35,y=0,col=c(1,'pink','coral'),lty=c(1,1,2),lwd=c(2,2,2),
       legend=c('Geweke','Jore1','Equal'))
...
plot(tail(date,K),rep(0,K),type='l',ylim=c(-450,10),ylab='',xlab='',xaxt="n",
     xlim=c(date[(nn+1)]-move.axis,date[(nn+K)]))
lines(tail(date,K),cumsum(apply(res4$lL_gew,2,median))-cumsum(apply(best.model$lL_gew,2,median)),
      col=1,lwd=2)
lines(tail(date,K),cumsum(apply(res4$lL_jore1,2,median))-cumsum(apply(best.model$lL_jore1,2,median)),
      col='pink',lwd=2)
lines(tail(date,K),cumsum(apply(res4$lL_equal,2,median))-cumsum(apply(best.model$lL_equal,2,median)),
      col='coral',lwd=2,lty=2)
axis(1, at=atx, labels=format(atx, "%Y/%m"),las=2,cex.axis=0.75)
legend(x=date[(nn+1)]-move.axis-35,y=0,col=c(1,'pink','coral'),
       lty=c(1,1,2),lwd=c(2,2,2),
...
lines(tail(date,K),cumsum(apply(res1$lL_jore1,2,median))-cumsum(apply(lL_caw,2,median)),
      col='pink',lwd=2)
lines(tail(date,K),cumsum(apply(res1$lL_equal,2,median))-cumsum(apply(lL_caw,2,median)),
      col='coral',lwd=2,lty=2)
axis(1, at=atx, labels=format(atx, "%Y/%m"),las=2,cex.axis=0.75)
legend(x=date[(nn+1)]-move.axis-35,y=0,col=c(1,'pink','coral'),
       lty=c(1,1,2),lwd=c(2,2,2),
...
lines(tail(date,K),cumsum(apply(res2$lL_jore1,2,median))-cumsum(apply(lL_caw,2,median)),
      col='pink',lwd=2)
lines(tail(date,K),cumsum(apply(res2$lL_equal,2,median))-cumsum(apply(lL_caw,2,median)),
      col='coral',lwd=2,lty=2)
axis(1, at=atx, labels=format(atx, "%Y/%m"),las=2,cex.axis=0.75)
legend(x=date[(nn+1)]-move.axis-35,y=0,col=c(1,'pink','coral'),lty=c(1,1,2),lwd=c(2,2,2),
       legend=c('Geweke','Jore1','Equal'))
...
plot(tail(date,K),mkvol,type='l',axes = FALSE,
     ...
     xlim=c(date[(nn+1)]-move.axis,date[(nn+K)]),main='CAW + AIW')
par(new = TRUE)
plot(tail(date,K),rep(0,K),type='l',ylim=c(-10,35),ylab='',xlab='',xaxt="n",
     xlim=c(date[(nn+1)]-move.axis,date[(nn+K)]))
...
lines(tail(date,K),cumsum(apply(res3$lL_jore1,2,median))-cumsum(apply(lL_caw,2,median)),
      col='pink',lwd=2)
lines(tail(date,K),cumsum(apply(res3$lL_equal,2,median))-cumsum(apply(lL_caw,2,median)),
      col='coral',lwd=2,lty=2)
axis(1, at=atx, labels=format(atx, "%Y/%m"),las=2,cex.axis=0.75)
legend(x=date[(nn+1)]-move.axis-35,y=0,col=c(1,'pink','coral'),lty=c(1,1,2),lwd=c(2,2,2),
       legend=c('Geweke','Jore1','Equal'))
...
plot(tail(date,K),mkvol,type='l',axes = FALSE,
     col='gray90',lwd=3,ylab='',xlab='',
     xlim=c(date[(nn+1)]-move.axis,date[(nn+K)]),main='CAW + RMf')
par(new = TRUE)
plot(tail(date,K),rep(0,K),type='l',ylim=c(-200,100),ylab='',xlab='',xaxt="n",
     xlim=c(date[(nn+1)]-move.axis,date[(nn+K)]))
...
lines(tail(date,K),cumsum(apply(res4$lL_jore1,2,median))-cumsum(apply(lL_caw,2,median)),
      col='pink',lwd=2)
lines(tail(date,K),cumsum(apply(res4$lL_equal,2,median))-cumsum(apply(lL_caw,2,median)),
      col='coral',lwd=2,lty=2)
axis(1, at=atx, labels=format(atx, "%Y/%m"),las=2,cex.axis=0.75)
legend(x=date[(nn+1)]-move.axis-35,y=0,col=c(1,'pink','coral'),
       lty=c(1,1,2),lwd=c(2,2,2),
